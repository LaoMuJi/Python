...
function createInstructions() {
	...
	text.innerHTML = '<span style="color:' + theme[0] + ';font-size:40px;">欢迎!</span><br /><br /><span style="font-size:15px;"><strong>操作说明：</strong><br /><br />1.拖一个球<br />2.点击背景<br />3.晃动你的鼠标<br />4.双击更换主题<br />5.开始玩吧!</span>';
